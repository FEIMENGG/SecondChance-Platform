                    ...
                    success: function (data) {
                        ...
                        if (data.length === 0) {
                            $all_product.append("<div class='product_content_div'>" +
                                ...
                                "<img src='' title='There are no products in this category at the moment' />" +
                                "<span class='detail_product_name'></span><br/>" +
                                "<span class='detail_product_cost'></span><br/>" +
                                "<span class='detail_buy product_1'>Add to cart</span>" +
                                "</figure>" +
                                "</div>");
                        }
                        for (var i = 0; i < data.length; i++) {
                            $all_product.append("<div class='product_content_div'>" +
                                ...
                                "<span class='detail_buy product_1' value='"+data[i].id+"'>Add to cart</span>" +
                                "</div>" +
                                "</div>");
                        }
            ...
            success: function (data) {
                ...
                if (data.length === 0) {
                    $all_product.append("<div class='product_content_div'>" +
                        "<div class='detail_product'>" +
                        "<input type='hidden' value= ''/>" +
                        "<div class='product_img_div'><img src='' title='There are no products in this category at the moment' /></div>" +
                        "<span class='detail_product_name'></span><br/>" +
                        "<span class='detail_product_cost'></span><br/>" +
                        "<span class='detail_buy product_1'>Add to cart</span>" +
                        "</div>" +
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if (result == '2'){
                        ...
                        alert('Something error occurred, please check the Internet');
                    }
                }
            })
        });
